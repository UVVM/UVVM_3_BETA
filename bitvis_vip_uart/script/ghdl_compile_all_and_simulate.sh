...
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_vip_uart ../src/uart_bfm_pkg.vhd
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_vip_uart ../src/vvc_transaction_pkg.vhd
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_vip_uart ../src/vvc_cmd_pkg.vhd
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_vip_uart ../src/monitor_cmd_pkg.vhd
...
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_vip_uart ../src/vvc_sb_pkg.vhd
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_vip_uart ../src/vvc_methods_pkg.vhd
...
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_vip_uart ../src/uart_rx_vvc.vhd
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_vip_uart ../src/uart_tx_vvc.vhd
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_vip_uart ../src/uart_vvc.vhd
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_vip_uart ../src/uart_monitor.vhd
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_vip_uart ../src/vvc_context.vhd
...
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_uart ../../bitvis_uart/src/uart_pkg.vhd
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_uart ../../bitvis_uart/src/uart_pif_pkg.vhd
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_uart ../../bitvis_uart/src/uart_pif.vhd
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_uart ../../bitvis_uart/src/uart_core.vhd
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_uart ../../bitvis_uart/src/uart.vhd

# Compiling UVVM demo TB
echo "Compiling TB..."
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_vip_uart ../tb/uvvm_demo_th.vhd
ghdl -a --std=08 -frelaxed-rules -Wno-hide -Wno-shared --work=bitvis_vip_uart ../tb/uvvm_demo_tb.vhd

# Running simulations
echo "Starting simulations..."
ghdl -e --std=08 -frelaxed-rules --work=bitvis_vip_uart uvvm_demo_tb
ghdl -r --std=08 -frelaxed-rules --work=bitvis_vip_uart uvvm_demo_tb
