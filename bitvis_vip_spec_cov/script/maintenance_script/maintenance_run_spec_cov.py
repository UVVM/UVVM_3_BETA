...
#                           |                      |                  |            |                       | requirement file.                                      |               |                     |
# --------------------------|----------------------|------------------|------------|-----------------------|--------------------------------------------------------|---------------|---------------------|-------------
# sub_req_file.csv          | UART_REQ_GENERAL     | TC_1             | pc_8.csv   | uart_map_file.csv     | Testing passing sub-requirement with test_status=NA,   | UART_REQ_BR_A | cfg_1_strict_0.txt  | sc_8_0.csv
#                           |                      |                  |            |                       | msg and SCOPE.                                         | UART_REQ_BR_B | cfg_1_strict_1.txt  | sc_8_1.csv
#                           |                      |                  |            |                       |                                                        | UART_REQ_ODD  | cfg_1_strict_2.txt  | sc_8_2.csv
#                           |                      |                  |            |                       |                                                        | UART_REQ_EVEN |                     |
# --------------------------|----------------------|------------------|------------|-----------------------|--------------------------------------------------------|---------------|---------------------|-------------
# sub _req_file.csv         | UART_REQ_GENERAL     | TC_1             | pc_9.csv   | uart_map_file.csv     | Testing failing sub-requirement with test_status=NA,   | UART_REQ_BR_A | cfg_2_strict_0.txt  | sc_9_0.csv
#                           |                      |                  |            |                       | msg and SCOPE.                                         | UART_REQ_BR_B | cfg_2_strict_1.txt  | sc_9_1.csv
#                           |                      |                  |            |                       |                                                        | UART_REQ_ODD  | cfg_2_strict_2.txt  | sc_9_2.csv
#                           |                      |                  |            |                       |                                                        | UART_REQ_EVEN |                     |
# --------------------------|----------------------|------------------|------------|-----------------------|--------------------------------------------------------|---------------|---------------------|-------------
# uart_req_file.csv         |UART_REQ_GENERAL_OMIT | TC_SUB_REQ_OMIT  | pc_16.csv  | uart_omit_map_file.csv| Testing omitted sub-requirement.                       | UART_REQ_BR_A |                     | sc_16.csv
...
# --------------------------|----------------------|------------------|------------|-----------------------|--------------------------------------------------------|---------------|---------------------|-------------
# uart_req_file.csv         | UART_REQ_ODD         | TC_SUB_REQ       | pc_19.csv  | uart_omit_map_file.csv| Testing sub-requirement with one sub-req not ticked    | UART_REQ_BR_A |                     | sc_19.csv
#                           | UART_REQ_EVEN        |                  |            |                       | off                                                    | UART_REQ_BR_B |                     |
#                           |                      |                  |            |                       |                                                        | UART_REQ_ODD  |                     |
#                           |                      |                  |            |                       |                                                        | UART_REQ_EVEN |                     |
#                           |                      |                  |            |                       |                                                        | UART_REQ_OMIT |                     |
# --------------------------|----------------------|------------------|------------|-----------------------|--------------------------------------------------------|---------------|---------------------|-------------
# req_file.csv              | REQ_1/2/3            | TC_1/2           |pc_20a/b.csv|                       | Testing strictness levels 0, 1 and 2                   |               | cfg_3_strict_0.txt  | sc_20_0.csv
#                           |                      |                  |            |                       |                                                        |               | cfg_3_strict_1.txt  | sc_20_1.csv
#                           |                      |                  |            |                       |                                                        |               | cfg_3_strict_1.txt  | sc_20_2.csv
# --------------------------|----------------------|------------------|------------|-----------------------|--------------------------------------------------------|---------------|---------------------|-------------
# combi_req_file.csv        | REQ_1/2/3/4          | TC_1             |pc_combi.csv|                       | Testing combination of AND- and OR- listed testcases   |               |                     | sc_combi.csv
# ==========================|======================|==================|============|=======================|========================================================|===============|=====================|=============
...
test_list = [
    [python_exe, "../script/run_spec_cov.py", "--strictness", "0", "-p", "../sim/pc_1.csv", "-s", "../sim/sc_1.csv"],
    [python_exe, "../script/run_spec_cov.py", "--strictness", "0", "-r", "../tb/maintenance_tb/req_file.csv", "-p", "../sim/pc_2.csv", "-s", "../sim/sc_2.csv"],
    [python_exe, "../script/run_spec_cov.py", "--strictness", "0", "-r", "../tb/maintenance_tb/req_file.csv", "-p", "../sim/pc_3.csv", "-s", "../sim/sc_3.csv"],
    [python_exe, "../script/run_spec_cov.py", "--strictness", "0", "-r", "../tb/maintenance_tb/req_file.csv", "-p", "../sim/pc_4.csv", "-s", "../sim/sc_4.csv"],
    [python_exe, "../script/run_spec_cov.py", "--strictness", "0", "-r", "../tb/maintenance_tb/req_file.csv", "-p", "../sim/pc_5.csv", "-s", "../sim/sc_5.csv"],
    [python_exe, "../script/run_spec_cov.py", "--strictness", "0", "-r", "../tb/maintenance_tb/req_file.csv", "-p", "../sim/pc_6.csv", "-s", "../sim/sc_6.csv"],
    [python_exe, "../script/run_spec_cov.py", "--strictness", "0", "-r", "../tb/maintenance_tb/req_file.csv", "-p", "../sim/pc_7.csv", "-s", "../sim/sc_7.csv"],
    [python_exe, "../script/run_spec_cov.py", "--config", "../tb/maintenance_tb/cfg_1_strict_0.txt"],
    [python_exe, "../script/run_spec_cov.py", "--config", "../tb/maintenance_tb/cfg_1_strict_1.txt"],
    [python_exe, "../script/run_spec_cov.py", "--config", "../tb/maintenance_tb/cfg_1_strict_2.txt"],
    [python_exe, "../script/run_spec_cov.py", "--config", "../tb/maintenance_tb/cfg_2_strict_0.txt"],
    [python_exe, "../script/run_spec_cov.py", "--config", "../tb/maintenance_tb/cfg_2_strict_1.txt"],
    [python_exe, "../script/run_spec_cov.py", "--config", "../tb/maintenance_tb/cfg_2_strict_2.txt"],
    [python_exe, "../script/run_spec_cov.py", "--strictness", "0", "-r", "../tb/maintenance_tb/req_file.csv", "-p", "../sim/pc_10.csv", "-s", "../sim/sc_10.csv"],
    [python_exe, "../script/run_spec_cov.py", "--strictness", "0", "-r", "../tb/maintenance_tb/req_file.csv", "-p", "../sim/pc_11.csv", "-s", "../sim/sc_11.csv"],
    [python_exe, "../script/run_spec_cov.py", "--strictness", "0", "-r", "../tb/maintenance_tb/req_file.csv", "-p", "../sim/pc_12.csv", "-s", "../sim/sc_12.csv"],
    [python_exe, "../script/run_spec_cov.py", "--strictness", "0", "-r", "../tb/maintenance_tb/req_file.csv", "-p", "../sim/pc_13.csv", "-s", "../sim/sc_13.csv"],
    [python_exe, "../script/run_spec_cov.py", "--strictness", "0", "-r", "../tb/maintenance_tb/req_file.csv", "-p", "../sim/pc_14.csv", "-s", "../sim/sc_14.csv"],
    [python_exe, "../script/run_spec_cov.py", "--strictness", "0", "-r", "../tb/maintenance_tb/req_file.csv", "-p", "../sim/pc_15.csv", "-s", "../sim/sc_15.csv"],
