...
def add_unwanted_activity_detection(file_handle, vvc_name, vvc_channel):
    ...
    file_handle.write("        -- v_vvc_config := get_vvc_config(VOID);\n")
    if vvc_channel != "NA":
        file_handle.write("        -- check_unwanted_activity(" + vvc_name.lower() + "_" + vvc_channel.lower() + "_vvc_if.last, v_vvc_config.unwanted_activity_severity, \"last\", C_SCOPE);\n")
        file_handle.write("        -- check_unwanted_activity(" + vvc_name.lower() + "_" + vvc_channel.lower() + "_vvc_if.data, v_vvc_config.unwanted_activity_severity, \"data\", C_SCOPE);\n")
    else:
        file_handle.write("        -- check_unwanted_activity(" + vvc_name.lower() + "_vvc_if.last, v_vvc_config.unwanted_activity_severity, \"last\", C_SCOPE);\n")
        file_handle.write("        -- check_unwanted_activity(" + vvc_name.lower() + "_vvc_if.data, v_vvc_config.unwanted_activity_severity, \"data\", C_SCOPE);\n")
    print_linefeed(file_handle)
    ...
    if vvc_channel != "NA":
        ...
        file_handle.write("        --   check_unwanted_activity(" + vvc_name.lower() + "_" + vvc_channel.lower() + "_vvc_if.valid, v_vvc_config.unwanted_activity_severity, \"valid\", C_SCOPE);\n")
        file_handle.write("        --   check_unwanted_activity(" + vvc_name.lower() + "_" + vvc_channel.lower() + "_vvc_if.data, v_vvc_config.unwanted_activity_severity, \"data\", C_SCOPE);\n")
    else:
        ...
        file_handle.write("        --   check_unwanted_activity(" + vvc_name.lower() + "_vvc_if.valid, v_vvc_config.unwanted_activity_severity, \"valid\", C_SCOPE);\n")
        file_handle.write("        --   check_unwanted_activity(" + vvc_name.lower() + "_vvc_if.data, v_vvc_config.unwanted_activity_severity, \"data\", C_SCOPE);\n")
    file_handle.write("        -- end if;\n")
    file_handle.write("      end if;\n")
    file_handle.write("    end loop;\n")
...
def add_vvc_context(file_handle, vvc_name, features):
    ...
    if features["transaction_pkg"]:
        file_handle.write("  use vip_" + vvc_name.lower() + ".vvc_transaction_pkg.all;\n")
        file_handle.write("  use vip_" + vvc_name.lower() + ".vvc_transaction_shared_variables_pkg.all;\n")
    file_handle.write("  use vip_" + vvc_name.lower() + ".vvc_methods_pkg.all;\n")
    file_handle.write("  use vip_" + vvc_name.lower() + ".vvc_methods_support_pkg.all;\n")
    if features["scoreboard"]:
        file_handle.write("  use vip_" + vvc_name.lower() + ".vvc_sb_support_pkg.all;\n")
