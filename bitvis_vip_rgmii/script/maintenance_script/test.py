...
# Add RGMII VIP
hr.add_files("../../src/*.vhd", "bitvis_vip_rgmii")
hr.add_files(
    "../../../uvvm_vvc_framework/src_target_dependent/*.vhd", "bitvis_vip_rgmii")

# Add TB/TH
hr.add_files("../../tb/maintenance_tb/*.vhd", "bitvis_vip_rgmii")
