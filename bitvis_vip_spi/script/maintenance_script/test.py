...
configs = create_config(spi_modes=range(0, 4), data_widths=[
                        8, 14, 23, 32], data_array_widths=[2, 4, 6, 8])
...
hr.add_files(
    "../../../uvvm_vvc_framework/src_target_dependent/*.vhd", "bitvis_vip_spi")
...
hr.add_files(
    "../../tb/maintenance_tb/spi_master_slave_opencores/trunk/rtl/spi_master_slave/spi_slave.vhd", "bitvis_vip_spi")
